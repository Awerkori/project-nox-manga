...
it('keeps parents before replies and orders replies chronologically', () => {
  const comments = [
    { id: 'reply2', parentId: 'root', createdAt: '2026-09-05T12:02:00Z' },
    { id: 'reply1', parentId: 'root', createdAt: '2026-09-05T12:01:00Z' },
    { id: 'root', parentId: null, createdAt: '2026-09-05T12:00:00Z' }
  ];
...
it('preserves replies whose original comment is outside the current page', () => {
  const orphan = { id: 'reply', parentId: 'older', createdAt: '2026-09-05' };
